...
INSERT INTO payments (employee_id, amount_cfa, amount_usd, date, status, reference, type) VALUES
(1, 620000, 1000.00, '2025-01-15', 'paid', 'PAY-2025-001', 'salary'),
(2, 465000, 750.00, '2025-01-15', 'paid', 'PAY-2025-002', 'salary'),
(3, 310000, 500.00, '2025-01-16', 'pending', 'PAY-2025-003', 'salary'),
(4, 775000, 1250.00, '2025-01-14', 'paid', 'PAY-2025-004', 'salary');
